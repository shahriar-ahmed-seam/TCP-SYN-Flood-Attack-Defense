...
% AUTHOR INPUT NEEDED: If desired, specify the host hardware environment (e.g., CPU model, RAM, and Linux kernel release) used during these namespace benchmarks.
