...
\titleformat{\chapter}[hang]
  {\normalfont\huge\bfseries\color{buetblue}\raggedright}
  {\chaptertitlename\ \thechapter:\ }{10pt}
  {\huge}[\vspace{6pt}{\color{buetblue!40}\hrule height 1.5pt}\vspace{10pt}]
...
\titleformat{\subsection}
  {\normalfont\large\bfseries\color{buetblue!90!black}}
  {\thesubsection}{6pt}{}
...
In the Linux kernel network stack, connection requests are processed through two distinct queues:
\begin{enumerate}
